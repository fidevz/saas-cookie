...
class TestPaywallMiddleware:
    ...
    def test_active_subscription_passes(self):
        ...
        plan = Plan.objects.create(name="Starter", amount=900, stripe_price_id="price_x", stripe_product_id="prod_x")
    ...
    def test_trialing_subscription_passes(self):
        ...
        plan = Plan.objects.create(name="Pro", amount=2900, stripe_price_id="price_y", stripe_product_id="prod_y")
        Subscription.objects.create(
            tenant=tenant,
            plan=plan,
    ...
    def test_cancelled_subscription_returns_402(self):
        ...
        tenant = Tenant.objects.create(name="Cancelled Co", slug="cancelled-co", owner=user)
        plan = Plan.objects.create(name="Old", amount=900, stripe_price_id="price_z", stripe_product_id="prod_z")
        Subscription.objects.create(
            tenant=tenant,
            plan=plan,
